...
//$route['^(\w{2})/artist/(:any)'] = 'artist/index/$2';
//$route['^(\w{2})/lyrics/(:any)/(:any)'] = 'lyrics/index/$2/$3';
//$route['^(\w{2})/dic/(:any)'] = 'dic/index/$2';

$route['artist/(:any)'] = 'artist/index/$1';
$route['lyrics/(:any)/(:any)'] = 'lyrics/index/$1/$2';
$route['dic/(:any)'] = 'dic/index/$1';
